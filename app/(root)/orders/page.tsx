        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500">
              ...
              <th className="min-w-[150px] py-3 text-left">Participant</th>
              <th className="min-w-[150px] py-3 text-left">Email</th>
              <th className="min-w-[150px] py-3 text-left">Phone</th>
                ...
                {orders &&
                  orders.map((row: IOrderItem) => (
                    <tr
                      ...
                      <td className="min-w-[100px] py-4">{row.buyer}</td>
                      <td className="min-w-[100px] py-4">{row.email}</td>
                      <td className="min-w-[100px] py-4">{row.phone_no}</td>
